 ...
 *
function formatdateexportcolumn_civicrm_navigationMenu(&$menu) {
  _formatdateexportcolumn_civix_insert_navigation_menu($menu, NULL, array(
    'label' => E::ts('The Page'),
    'name' => 'the_page',
  ...
  _formatdateexportcolumn_civix_navigationMenu($menu);
} // */
